...
The prototype may use a labeled logo placeholder. Obtain the original transparent SVG or high-resolution PNG assets before implementation; do not extract a production logo from a PDF screenshot.
...
- Original approved Team BEAN transparent logo files, preferably SVG plus PNG variants.
...
These do not block creating a fake-data prototype with placeholders.
